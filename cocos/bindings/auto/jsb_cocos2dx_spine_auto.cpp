...
static bool js_cocos2dx_spine_Skin_findAttachmentsForSlot(se::State& s)
{
    ...
    if (argc == 2) {
        HolderType<size_t, false> arg0 = {};
        HolderType<spine::Vector<spine::Attachment *>, true> arg1 = {};
        ok &= sevalue_to_native(args[0], &arg0, s.thisObject());
        ok &= sevalue_to_native(args[1], &arg1, s.thisObject());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_Skin_findAttachmentsForSlot : Error processing arguments");
        cobj->findAttachmentsForSlot(arg0.value(), arg1.value());
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 2);
    return false;
...
static bool js_cocos2dx_spine_VertexEffectDelegate_constructor(se::State& s) // constructor.c
{
...
static bool js_cocos2dx_spine_SkeletonRenderer_getParamsBuffer(se::State& s)
{
    spine::SkeletonRenderer* cobj = SE_THIS_OBJECT<spine::SkeletonRenderer>(s);
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_spine_SkeletonRenderer_getParamsBuffer : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_SkeletonRenderer_getParamsBuffer : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_spine_SkeletonRenderer_getParamsBuffer)

static bool js_cocos2dx_spine_SkeletonRenderer_getSharedBufferOffset(se::State& s)
{
    spine::SkeletonRenderer* cobj = SE_THIS_OBJECT<spine::SkeletonRenderer>(s);
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_spine_SkeletonRenderer_getSharedBufferOffset : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_SkeletonRenderer_getSharedBufferOffset : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_spine_SkeletonRenderer_getSharedBufferOffset)
...
static bool js_cocos2dx_spine_SkeletonRenderer_setAttachEnabled(se::State& s)
{
    spine::SkeletonRenderer* cobj = SE_THIS_OBJECT<spine::SkeletonRenderer>(s);
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_spine_SkeletonRenderer_setAttachEnabled : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        HolderType<bool, false> arg0 = {};
        ok &= sevalue_to_native(args[0], &arg0, s.thisObject());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_SkeletonRenderer_setAttachEnabled : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_spine_SkeletonRenderer_setAttachEnabled)
...
static bool js_cocos2dx_spine_SkeletonRenderer_constructor(se::State& s)  // constructor_overloaded.c
{
    CC_UNUSED bool ok = true;
    const auto& args = s.args();
    size_t argc = args.size();
...
bool js_register_cocos2dx_spine_SkeletonRenderer(se::Object* obj)
{
    ...
    cls->defineFunction("getParamsBuffer", _SE(js_cocos2dx_spine_SkeletonRenderer_getParamsBuffer));
    cls->defineFunction("getSharedBufferOffset", _SE(js_cocos2dx_spine_SkeletonRenderer_getSharedBufferOffset));
    ...
    cls->defineFunction("setAttachEnabled", _SE(js_cocos2dx_spine_SkeletonRenderer_setAttachEnabled));
...
static bool js_cocos2dx_spine_SkeletonAnimation_constructor(se::State& s) // constructor.c
{
...
static bool js_cocos2dx_spine_SkeletonDataMgr_constructor(se::State& s) // constructor.c
{
...
static bool js_cocos2dx_spine_SkeletonCacheAnimation_getParamsBuffer(se::State& s)
{
    spine::SkeletonCacheAnimation* cobj = SE_THIS_OBJECT<spine::SkeletonCacheAnimation>(s);
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_spine_SkeletonCacheAnimation_getParamsBuffer : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        se_object_ptr result = cobj->getParamsBuffer();
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_SkeletonCacheAnimation_getParamsBuffer : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_spine_SkeletonCacheAnimation_getParamsBuffer)

static bool js_cocos2dx_spine_SkeletonCacheAnimation_getSharedBufferOffset(se::State& s)
{
    spine::SkeletonCacheAnimation* cobj = SE_THIS_OBJECT<spine::SkeletonCacheAnimation>(s);
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_spine_SkeletonCacheAnimation_getSharedBufferOffset : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        se_object_ptr result = cobj->getSharedBufferOffset();
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_SkeletonCacheAnimation_getSharedBufferOffset : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_spine_SkeletonCacheAnimation_getSharedBufferOffset)
...
static bool js_cocos2dx_spine_SkeletonCacheAnimation_setAttachEnabled(se::State& s)
{
    spine::SkeletonCacheAnimation* cobj = SE_THIS_OBJECT<spine::SkeletonCacheAnimation>(s);
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_spine_SkeletonCacheAnimation_setAttachEnabled : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        HolderType<bool, false> arg0 = {};
        ok &= sevalue_to_native(args[0], &arg0, s.thisObject());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_SkeletonCacheAnimation_setAttachEnabled : Error processing arguments");
        cobj->setAttachEnabled(arg0.value());
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
...
SE_BIND_FUNC(js_cocos2dx_spine_SkeletonCacheAnimation_setAttachEnabled)
...
static bool js_cocos2dx_spine_SkeletonCacheAnimation_constructor(se::State& s) // constructor.c
{
    CC_UNUSED bool ok = true;
    const auto& args = s.args();
    std::string arg0;
...
bool js_register_cocos2dx_spine_SkeletonCacheAnimation(se::Object* obj)
{
    ...
    cls->defineFunction("getParamsBuffer", _SE(js_cocos2dx_spine_SkeletonCacheAnimation_getParamsBuffer));
    cls->defineFunction("getSharedBufferOffset", _SE(js_cocos2dx_spine_SkeletonCacheAnimation_getSharedBufferOffset));
    ...
    cls->defineFunction("setAttachEnabled", _SE(js_cocos2dx_spine_SkeletonCacheAnimation_setAttachEnabled));
